...
public class CompanyController extends BaseController {
    ...
    public ResponseEntity<Recruiters> createRecruiters(@RequestPart("addRecruiter") String recruiterstr, @RequestPart("image") MultipartFile file) throws IOException {
